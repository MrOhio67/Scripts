...
WindowConfig.IntroText = WindowConfig.IntroText or "Starting BadBull Script.."
...
local WindowStuff = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
	...
	SetChildren(SetProps(MakeElement("TFrame"), {
		...
		AddThemeObject(SetProps(MakeElement("Label", "BadBull", WindowConfig.HidePremium and 14 or 13), {
